...
instr_func opcode_entry[256] = {
    /* 0x00 - 0x03*/ add_r2rm_b, add_r2rm_v, __ref_add_rm2r_b, add_rm2r_v,
    ...
    /* 0x28 - 0x2b*/ inv, sub_r2rm_v, sub_rm2r_b, sub_rm2r_v,
...
instr_func group_1_b_entry[8] =
    {inv, __ref_or_i2rm_b, inv, inv, and_i2rm_b, inv, __ref_xor_i2rm_b, cmp_i2rm_b};
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x94 - 0x97*/ __ref_sete_b, setne_b, inv, inv,
